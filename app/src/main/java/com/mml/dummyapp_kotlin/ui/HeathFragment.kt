...
import com.mml.dummyapp_kotlin.databinding.HeathFragmentBinding
...
private const val TAG = "HeathFragment"

@AndroidEntryPoint
class HeathFragment : Fragment(), TitleAndGridLayout {
    private var _binding: HeathFragmentBinding? = null
...
//        postViewModel = ViewModelProvider(this)[PostViewModel::class.java]
        ...
        postViewModel.finalURL.value =
            BASE_URL_POSTS_BY_LABEL + "posts/search?q=label:Heath&key=" + API_KEY
...
//        gridLayoutManager = GridLayoutManager(context, 3)
    ...
    override fun onCreateView(
        ...
        _binding = HeathFragmentBinding.inflate(inflater, container, false)
        setHasOptionsMenu(true)

        postViewModel.label.value = "Heath"

//        itemArrayList = ArrayList()
//        adapter = PostAdapter(context!!, itemArrayList, this)
        ...
        postViewModel.recyclerViewLayout.observe(viewLifecycleOwner) { layout ->
            ...
            when (layout) {
                "cardLayout" -> {
                    ...
                    binding.heathRecyclerView.layoutManager = layoutManager
                    adapter.setViewType(0)
                    binding.heathRecyclerView.adapter = adapter
                }
                "cardMagazineLayout" -> {
                    binding.loadMoreBtn.visibility = View.VISIBLE
                    binding.heathRecyclerView.layoutManager = layoutManager
                ...
                "titleLayout" -> {
                    ...
                    binding.heathRecyclerView.layoutManager = titleLayoutManager
                    adapter.setViewType(2)
                    binding.heathRecyclerView.adapter = adapter
                }
                "gridLayout" -> {
                    binding.loadMoreBtn.visibility = View.GONE
                    binding.heathRecyclerView.layoutManager = gridLayoutManager
...
//                binding.homeRecyclerView.adapter = mAdapter
    ...
    private fun showShimmerEffect() {
        binding.apply {
            ...
            heathRecyclerView.visibility = View.INVISIBLE
        }
    ...
    private fun hideShimmerEffect() {
        binding.apply {
            ...
            heathRecyclerView.visibility = View.VISIBLE
        }
    }
...
//                    editor.apply();
    ...
    private fun noInternetConnectionLayout() {
        binding.apply {
            shimmerLayout.stopShimmer()
            shimmerLayout.visibility = View.GONE
            heathRecyclerView.visibility = View.GONE
