...
import com.mml.dummyapp_kotlin.databinding.SportsFragmentBinding
...
@AndroidEntryPoint
class SportsFragment : Fragment(), TitleAndGridLayout {
...
//        postViewModel = ViewModelProvider(this)[PostViewModel::class.java]
        ...
        postViewModel.finalURL.value =
            BASE_URL_POSTS_BY_LABEL + "posts/search?q=label:Sports&key=" + API_KEY
...
//        gridLayoutManager = GridLayoutManager(context, 3)
    ...
    override fun onCreateView(
        ...
        _binding = SportsFragmentBinding.inflate(inflater, container, false)
        setHasOptionsMenu(true)

        postViewModel.label.value = "Sports"
        ...
        postViewModel.recyclerViewLayout.observe(viewLifecycleOwner) { layout ->
            ...
            when (layout) {
                "cardLayout" -> {
                    ...
                    binding.sportsRecyclerView.layoutManager = layoutManager
                ...
                "titleLayout" -> {
                    ...
                    binding.sportsRecyclerView.layoutManager = titleLayoutManager
                    adapter.setViewType(2)
                    binding.sportsRecyclerView.adapter = adapter
                }
                "gridLayout" -> {
                    binding.loadMoreBtn.visibility = View.GONE
                    binding.sportsRecyclerView.layoutManager = gridLayoutManager
...
//                binding.homeRecyclerView.adapter = mAdapter
    ...
    private fun showShimmerEffect() {
        binding.apply {
            ...
            sportsRecyclerView.visibility = View.INVISIBLE
        }
    ...
    private fun hideShimmerEffect() {
        binding.apply {
            ...
            sportsRecyclerView.visibility = View.VISIBLE
        }
    }
...
//                    editor.apply();
    ...
    private fun noInternetConnectionLayout() {
        binding.apply {
            shimmerLayout.stopShimmer()
            shimmerLayout.visibility = View.GONE
            sportsRecyclerView.visibility = View.GONE
