...
import com.mml.dummyapp_kotlin.databinding.FragmentArcadeBinding
...
private const val TAG = "ArcadeFragment"

@AndroidEntryPoint
class ArcadeFragment : Fragment(), TitleAndGridLayout {
...
//        postViewModel = ViewModelProvider(this)[PostViewModel::class.java]
        ...
        postViewModel.finalURL.value =
            BASE_URL_POSTS_BY_LABEL + "posts/search?q=label:Arcade&key=" + API_KEY
...
//        gridLayoutManager = GridLayoutManager(context, 3)
    ...
    override fun onCreateView(
        ...
        postViewModel.label.value = "Arcade"
        ...
        postViewModel.recyclerViewLayout.observe(viewLifecycleOwner) { layout ->
            ...
            when (layout) {
                "cardLayout" -> {
                    ...
                    binding.arcadeRecyclerView.layoutManager = layoutManager
                    adapter.setViewType(0)
                    binding.arcadeRecyclerView.adapter = adapter
                }
                "cardMagazineLayout" -> {
                    binding.loadMoreBtn.visibility = View.VISIBLE
                    binding.arcadeRecyclerView.layoutManager = layoutManager
                ...
                "titleLayout" -> {
                    ...
                    binding.arcadeRecyclerView.layoutManager = titleLayoutManager
                    adapter.setViewType(2)
                    binding.arcadeRecyclerView.adapter = adapter
                }
                "gridLayout" -> {
                    binding.loadMoreBtn.visibility = View.GONE
                    binding.arcadeRecyclerView.layoutManager = gridLayoutManager
...
//                binding.homeRecyclerView.adapter = mAdapter
    ...
    private fun showShimmerEffect() {
        binding.apply {
            ...
            arcadeRecyclerView.visibility = View.INVISIBLE
        }
    ...
    private fun hideShimmerEffect() {
        binding.apply {
            ...
            arcadeRecyclerView.visibility = View.VISIBLE
        }
    }
...
//                    editor.apply();
    ...
    private fun noInternetConnectionLayout() {
        binding.apply {
            shimmerLayout.stopShimmer()
            shimmerLayout.visibility = View.GONE
            arcadeRecyclerView.visibility = View.GONE
