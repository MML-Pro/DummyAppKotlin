...
import com.mml.dummyapp_kotlin.databinding.FoodFragmentBinding
...
@AndroidEntryPoint
class FoodFragment : Fragment(), TitleAndGridLayout {
...
//        postViewModel = ViewModelProvider(this)[PostViewModel::class.java]
        ...
        postViewModel.finalURL.value =
            BASE_URL_POSTS_BY_LABEL + "posts/search?q=label:Food&key=" + API_KEY
...
//        gridLayoutManager = GridLayoutManager(context, 3)
    ...
    override fun onCreateView(
        ...
        postViewModel.label.value = "Food"
        ...
        postViewModel.recyclerViewLayout.observe(viewLifecycleOwner) { layout ->
            ...
            when (layout) {
                ...
                "titleLayout" -> {
                    ...
                    binding.foodRecyclerView.layoutManager = titleLayoutManager
...
//                binding.homeRecyclerView.adapter = mAdapter
    ...
    private fun showShimmerEffect() {
        binding.apply {
            ...
            foodRecyclerView.visibility = View.INVISIBLE
        }
