...
import com.mml.dummyapp_kotlin.databinding.FragmentAccessoryBinding
...
@AndroidEntryPoint
class AccessoryFragment : Fragment(), TitleAndGridLayout {
...
//        postViewModel = ViewModelProvider(this)[PostViewModel::class.java]
        ...
        postViewModel.finalURL.value =
            BASE_URL_POSTS_BY_LABEL + "posts/search?q=label:Accessory&key=" + API_KEY
        ...
        postViewModel.recyclerViewLayout.observe(viewLifecycleOwner) { layout ->
            ...
            when (layout) {
                "cardLayout" -> {
                    ...
                    binding.accessoryRecyclerView.layoutManager = layoutManager
