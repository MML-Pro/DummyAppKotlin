...
import com.mml.dummyapp_kotlin.databinding.FragmentFashionBinding
...
private const val TAG = "FashionFragment"

@AndroidEntryPoint
class FashionFragment : Fragment(), TitleAndGridLayout {
...
//        postViewModel = ViewModelProvider(this)[PostViewModel::class.java]
        ...
        postViewModel.finalURL.value =
            BASE_URL_POSTS_BY_LABEL + "posts/search?q=label:Fashion&key=" + API_KEY
...
//        gridLayoutManager = GridLayoutManager(context, 3)
    ...
    override fun onCreateView(
        ...
        postViewModel.label.value = "Fashion"
        ...
        postViewModel.recyclerViewLayout.observe(viewLifecycleOwner) { layout ->
            ...
            when (layout) {
                "cardLayout" -> {
                    ...
                    binding.fashionRecyclerView.layoutManager = layoutManager
                    adapter.setViewType(0)
                    binding.fashionRecyclerView.adapter = adapter
                }
                "cardMagazineLayout" -> {
                    binding.loadMoreBtn.visibility = View.VISIBLE
                    binding.fashionRecyclerView.layoutManager = layoutManager
                ...
                "titleLayout" -> {
                    ...
                    binding.fashionRecyclerView.layoutManager = titleLayoutManager
                    adapter.setViewType(2)
                    binding.fashionRecyclerView.adapter = adapter
                }
                "gridLayout" -> {
                    binding.loadMoreBtn.visibility = View.GONE
                    binding.fashionRecyclerView.layoutManager = gridLayoutManager
...
//                binding.homeRecyclerView.adapter = mAdapter
    ...
    private fun showShimmerEffect() {
        binding.apply {
            ...
            fashionRecyclerView.visibility = View.INVISIBLE
        }
    ...
    private fun hideShimmerEffect() {
        binding.apply {
            ...
            fashionRecyclerView.visibility = View.VISIBLE
        }
    }
...
//                    editor.apply();
    ...
    private fun noInternetConnectionLayout() {
        binding.apply {
            shimmerLayout.stopShimmer()
            shimmerLayout.visibility = View.GONE
            fashionRecyclerView.visibility = View.GONE
